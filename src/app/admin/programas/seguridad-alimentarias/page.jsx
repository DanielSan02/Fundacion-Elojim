...
export default function SeguridadAlimentariaPage() {
  ...
  const registrosFiltrados = registros.filter((registro) => {
    ...
    const matchesEdad = edad ? registro.edad === parseInt(edad) : true;

    return matchesBusqueda && matchesComuna && matchesEstrato && matchesGrupo && matchesEdad;
  });
    ...
    <ContentLayout title="Programa Seguridad Alimentaria">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Seguridad Alimentaria</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
        ...
        <table className="min-w-full table-auto mt-4 border">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="py-2 px-4 border">Número Documento</th>
