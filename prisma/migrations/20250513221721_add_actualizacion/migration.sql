/*
  ...
  - The values [Música] on the enum `AreaInteresCultural` will be removed. If these variants are still used in the database, this will fail.
  - The values [Indígena] on the enum `GrupoEtnico` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "AreaInteresCultural_new" AS ENUM ('Musica', 'Danza', 'Manualidades', 'Maquillaje', 'Dibujo', 'Otro');
...
-- AlterEnum
BEGIN;
CREATE TYPE "GrupoEtnico_new" AS ENUM ('Ninguno', 'Afrodescendiente', 'Indigena', 'Raizal', 'Rom_Gitano', 'Palenquero', 'Otro');
